...
class KegControl extends React.Component {
  ...
  render() {
    ...
    if (this.state.editing) {
      ...
      currentlyVisibleState = <KegList kegList={this.state.masterKegList} onKegSelection={this.handleChangingSelectedKeg} onClickingBuyPint={this.handleBuyPintClick}/>
